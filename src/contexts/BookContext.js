...
// context API
// default olarak export ediyoruz ki başka js dosyalarında kullanabilelim.
...
class BookContextProvider extends React.Component {
    ...
    render(){
        ...
        // value={this.state olarak yolladğımız objeyi diğer tarafta başka isimle kullanabiliriz illaki vau adında kullanma zorunluluğumuz yok.}
    }
...
// iki yol var  
//1-(-this.context) default value gerekiyor (array, nesne, değişken olabilir) 
//2--provider -->consumer 
